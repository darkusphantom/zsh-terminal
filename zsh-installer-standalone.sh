...
installCustomConfiguration() {
    ...
    # Create git aliases
    cat > "${CONFIG_ZSH_DIR}/git_aliases.zsh" << 'EOF'
# Git aliases
alias arbolito="git log --oneline --graph --decorate"
EOF
    
    # Create shell aliases
    cat > "${CONFIG_ZSH_DIR}/shell_aliases.zsh" << 'EOF'
...
# Package management
alias installApt="sudo apt install"
alias installSnap="sudo snap install"
alias removeApt="sudo apt remove"
alias removeSnap="sudo snap remove"
EOF
    
    # Create environment variables
    cat > "${CONFIG_ZSH_DIR}/environment.zsh" << 'EOF'
